...
import com.palma.apps.graziapp.databinding.ActivityMyOrderDetailsBinding
...
class MyOrderDetailsActivity : AppCompatActivity() {
    ...
    private fun setUpUI(orderDetails : Order){
        ...
        when{
            ...
            diffInHours < 2->{
                binding.tvOrderStatus.text = getString(R.string.enproceso)
                binding.tvOrderStatus.setTextColor(
                    ContextCompat.getColor(
                        this@MyOrderDetailsActivity,
            ...
            //if time is greater than 2 hour
                ...
                binding.tvOrderStatus.text = getString(R.string.entregado)
                binding.tvOrderStatus.setTextColor(
                    ContextCompat.getColor(
                        this@MyOrderDetailsActivity,
        ...
        val adapter = ItemsCarritoListAdapter(this,orderDetails.items,false)
        ...
        binding.tvMyOrderDetailsAddress.text = "${orderDetails.address.address} , ${orderDetails.address.addressnumber}"
